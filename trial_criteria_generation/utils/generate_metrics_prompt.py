...
def generate_metrics_prompt(values: list):
    ...
    metrics_base_prompt = (
        ...
        count their occurrences, and return the source document IDs where each criterion appears. Occurrences count can be zero.
        Like if pregnancy is not provided as criteria return it with count of 0.
        ### Input Format:
